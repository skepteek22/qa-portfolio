...
| :-- | :--- | :--- | :--- | :--- |
| **1** | Add product to cart | User is on a Product Detail Page (PDP). | 1. Click the **"Add to Cart"** button.<br>2. Open the **Cart** page. | Product is displayed in the cart with the correct name, image, and price.<br>Cart icon badge updates to **"1"**. |
